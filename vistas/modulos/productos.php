            ...
            <!-- ENTRADA PARA LA DESCRIPCIÓN -->
             ...
             <div class="form-group">
              ...
              <div class="input-group">
                ...
                <input type="hidden" name="nuevoStock" value="0" required>
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <select class="form-control input-lg"  name="editarProveedor">
                  ...
                  <option id="editarProveedor" value="">Seleccionar proveedor</option>
            ...
            <!-- ENTRADA PARA LA DESCRIPCIÓN -->
             ...
             <div class="form-group">
              ...
              <div class="input-group">
                ...
                <input type="hidden" id="editarStock" name="editarStock" required>
...
<!--=====================================
MODAL GENERAR CODIGOS DE BARRA
======================================-->

<div id="modalGenerarCodigosBarras" class="modal fade" role="dialog">
    ...
    <div class="modal-content">
      ...
      <form role="form" method="post" enctype="multipart/form-data">
        ...
        <div class="modal-header" style="background:#3c8dbc; color:white">
          ...
          <h4 class="modal-title">Resumen de códigos de barra</h4>
        ...
        ======================================-->
          ...
          <div class="box">
            <!-- /.box-header -->
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped dt-responsive tablaBarras">
                <thead>
                <tr>
                  <th>Producto</th>
                  <th>Código</th>
