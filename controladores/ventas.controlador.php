	...
	static public function ctrCrearVenta(){
		...
		if(isset($_POST["nuevaVenta"])){
			...
			if($respuesta == "ok"){
			    ...
			    $vendedor = ControladorUsuarios::ctrMostrarUsuarios("id", $_POST["idVendedor"]);
...
<div style="text-decoration:none;display:inline-block;color:#FFFFFF;background-color:#FF5F54;border-radius:4px;-webkit-border-radius:4px;-moz-border-radius:4px;width:auto; width:auto;;border-top:1px solid #FF5F54;border-right:1px solid #FF5F54;border-bottom:1px solid #FF5F54;border-left:1px solid #FF5F54;padding-top:5px;padding-bottom:5px;font-family:Arial, Helvetica, sans-serif;text-align:center;mso-border-alt:none;word-break:keep-all;"><span style="padding-left:20px;padding-right:20px;font-size:14px;display:inline-block;"><span style="font-size: 16px; line-height: 32px;"><strong><a href="http://ventas.huamachucostore.com" target="_BLANK" data-mce-style="font-family: arial, helvetica, sans-serif; font-size: 14px; line-height: 28px;" style="font-family: arial, helvetica, sans-serif; font-size: 14px; line-height: 28px; text-decoration: none; color: #fff">VERIFICAR</a></strong></span></span></div>
<!--[if mso]></center></v:textbox></v:roundrect></td></tr></table><![endif]-->
<div style="color:#27294A;font-family:Arial, "Helvetica Neue", Helvetica, sans-serif;line-height:120%;padding-top:10px;padding-right:10px;padding-bottom:10px;padding-left:0px;">
<div style="font-family: Arial, "Helvetica Neue", Helvetica, sans-serif; font-size: 12px; line-height: 14px; color: #27294A;">
<p style="font-size: 14px; line-height: 19px; margin: 0;"><span style="font-family: georgia, palatino; font-size: 16px;">Registrado por: <strong>'.$vendedor["nombre"].'</strong></span></p>
</div>
<div style="color:#27294A;font-family:Arial, "Helvetica Neue", Helvetica, sans-serif;line-height:120%;padding-top:10px;padding-right:10px;padding-bottom:10px;padding-left:0px;">

<p style="font-size: 14px; line-height: 19px; margin: 0;"><span style="font-family: georgia, palatino; font-size: 16px;">El '.$fecha.'</span></p>
